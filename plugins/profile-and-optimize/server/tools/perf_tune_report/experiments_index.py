...
keyed by the experiment-id join key (CLAUDE.md "Experiment Isolation &
...
in the perf-report bundle (data, not Python -- per perf-tune-report/CLAUDE.md).
"""
...
# count keyed by the run-id join key (CLAUDE.md "Experiment Isolation &
...
def render_inventory_md(inv: dict[str, Any]) -> str:
    ...
    lines += [
        ...
        "campaign (CLAUDE.md \"Experiment Isolation & Traceability\"). Pass `--bundle-root` "
