...
The server's ``AGENTS.md`` "Speed-of-light framing" guidance says every
...
4. Caveat footer: sample-share-is-time-proxy disclaimer, link to the server's AGENTS.md
...
def render_page(
    ...
    ax_cv.text(
        ...
        "use inference-kernel-ncu-profile. See the server AGENTS.md 'Speed-of-light framing'.",
        ha="center",
        va="center",
        fontsize=7,
        color="#777777",
